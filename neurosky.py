...
if 'TRIAL_PERMUTATION' not in globals():
    ...
    # TODO sequence of events instead of random
###############################################################
...
# TODO have a listener that's waiting for the main game
...
if __name__ == "__main__":
    ...
    # game_thread.start()
    # TODO look into subprocessing
    # TODO look into piping
    ...
    if not SKIP_OFFLINE:
        ...
        try:
            ...
            while (time.time()- START_TIME) < SESSION_DURATION:
                ...
                # TODO label is updated here
                # add key listeners from pygame
